...
local function font_with_fallback(name, params)
	local names = { name, "Apple Color Emoji", "azuki_font", "Noto Sans Devanagari" }
...
return {
	...
	colors = {
		...
		split = "#090909",
		ansi = { "#13365e", "#93B3EB", "#ACC9F0", "#B3CCF8", "#E4CED1", "#CBD9F9", "#E7DBEA", "#e2e8f5" },
		-- ansi = { "#087763", "#257B64", "#1C8067", "#328569", "#4F926C", "#639D6D", "#afc9ad", "#e4e6e7" },
